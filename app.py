...
st.set_page_config(
    page_title="🌾 Krish कृषि सहायक", 
    layout="wide", 
    initial_sidebar_state="expanded",
    menu_items={
        'Get Help': None,
        'Report a bug': None,
        'About': "Krish कृषि सहायक - आपका डिजिटल खेती सलाहकार"
    }
)
...
आपको किसानों को उनकी स्थानीय परिस्थितियों के अनुसार सलाह देनी है। Apka naam Krish hai 
